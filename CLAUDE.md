...
ui/styles.py             design system: "soft deep-space" palette + QSS
                         (session 9; spec mockup in .superdesign/,
                         gitignored): accent #7C93FF, primary-action
                         gradient #4E6EF2→#7A5AF8 (GRADIENT token), bg
                         gradient #0B1226→#070B16, cards #101830 with
                         hairline rgba borders (BORDER_SOFT; BORDER stays
                         hex for matplotlib), pill tabs, radii 9–14px.
                         ALL widget styling flows through these tokens.
